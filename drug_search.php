...
<body>
    <div class="container">
        ...
        <header>
            ...
            <button onclick="window.location.href='index.php'" class="button-40 btn-new btn-top-left"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
